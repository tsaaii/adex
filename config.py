...
BACKUP BEHAVIOR:
- Only TODAY's folder gets backed up to cloud storage
- Incremental backup: only new/changed files are uploaded
- Previous days' folders remain local unless manually uploaded
